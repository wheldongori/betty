...
<div class="card-header">
          <p class="lead"> <strong>COMPANIES</strong></p>   <a href="create.php" class="btn btn-primary  ">  
          <i class="fa fa-plus-circle fw-fa"></i> New</a></div><br/>
<table style = " font-family: arial, sans-serif;border-collapse: collapse; width = 70%;">
                       
                       <tr>
               
                           <th style = " border: 1px solid #dddddd;text-align: left;padding: 8px;"><strong>COMPANY ID</strong></th>
                           <th style = " border: 1px solid #dddddd;text-align: left;padding: 8px;"><strong>COMPANY</strong></th>
                           <th style = " border: 1px solid #dddddd;text-align: left;padding: 8px;"><strong>ACTIONS</strong></th>
                                                   ...
                                                   <tr>
                       <td style = " border: 1px solid #dddddd;text-align: left;padding: 8px;"><?=$compId;?></td>
                       <td style = " border: 1px solid #dddddd;text-align: left;padding: 8px;"><?=$company;?></td>
                       <td style = " border: 1px solid #dddddd;text-align: left;padding: 8px;">
                       <a title="Edit" href="edit.php?req=<?=$compId;?>"  class="btn btn-success btn-sm  "> 
                        <span class="fa fa-edit fw-fa"></span></a>
                        <a title="view" href="view.php?req=<?=$compId;?>"  class="btn btn-primary btn-sm  "> 
